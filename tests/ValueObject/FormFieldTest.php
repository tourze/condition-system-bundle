...
{
    public function test_create_basic_field(): void
    {
    ...
    public function test_required_method_returns_new_instance(): void
    {
    ...
    public function test_required_with_false_parameter(): void
    {
    ...
    public function test_help_method_sets_help_text(): void
    {
        $helpText = '请输入有效的邮箱地址';
    ...
    public function test_options_method_merges_options(): void
    {
    ...
    public function test_constraints_method_merges_constraints(): void
    {
    ...
    public function test_min_constraint_shortcut(): void
    {
    ...
    public function test_max_constraint_shortcut(): void
    {
    ...
    public function test_choices_option_shortcut(): void
    {
    ...
    public function test_to_array_with_minimal_field(): void
    {
