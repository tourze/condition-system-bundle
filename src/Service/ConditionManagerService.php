...
#[WithMonologChannel(channel: 'condition_system')]
readonly class ConditionManagerService
{
    ...
    public function getAvailableConditionTypes(?ConditionTrigger $trigger = null): array
    {
        ...
        return array_filter($types, function ($typeInfo) use ($trigger) {
            ...
            $supportedTriggers = $typeInfo['supportedTriggers'];

            return in_array($trigger, $supportedTriggers, true);
        });
    }
